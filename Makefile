...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ifeq ($(PLATFORM_OS),WINDOWS)
        ...
        LDLIBS = -lraylib -lopengl32 -lgdi32 -lwinm
        CC = g++
        EXT = .exe
...
OBJS ?= main.cpp NPC.cpp Player.cpp Bullet.cpp GameCalendar.cpp Platform.cpp shaderControl.cpp raygui_impl.cpp Particle.cpp GameResources.cpp Globals.cpp Grenade.cpp
